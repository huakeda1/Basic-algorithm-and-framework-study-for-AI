...
class Model(nn.Module):
    ...
    def init_optimizer(self, args, num_train_iters):
        ...
        self.scheduler = get_linear_schedule_with_warmup(self.optimizer,num_warmup_steps=int(args.warmup_proportion*num_train_iters),num_training_steps=num_train_iters)
