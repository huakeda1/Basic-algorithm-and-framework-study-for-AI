...
if __name__ == '__main__':
    predict_golden = json.load(open('./crosswoz/output/all_context/output.json',encoding='utf-8'))
    print('all', calculateF1(predict_golden))
    goal_types = get_goal_type(read_zipped_json('./crosswoz/data/test.json.zip', 'test.json',),mode='all')
    type_predict_golden = {}
